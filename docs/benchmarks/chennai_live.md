...
Window 2026-07-12 → 2026-08-19, test from **2026-08-09** (single temporal split; train strictly before each test origin). 6 station cells, 5,024 hourly rows. Model: LightGBM quantile (median) — same class/params as production (ml.forecast.train). Generated 2026-08-19T11:52Z by `python -m ml.eval.benchmark`.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| full_test | 24 | 718 | 13.22 | 16.14 | 13.64 | **12.75** | +3.5% | 12.82 | +3.0% |
| non_winter | 24 | 718 | 13.22 | 16.14 | 13.64 | **12.75** | +3.5% | 12.82 | +3.0% |
| full_test | 48 | 615 | 14.3 | 14.12 | 14.07 | **13.67** | +4.4% | 13.69 | +4.3% |
| non_winter | 48 | 615 | 14.3 | 14.12 | 14.07 | **13.67** | +4.4% | 13.69 | +4.3% |
| full_test | 72 | 499 | 15.74 | 15.11 | 15.03 | **14.79** | +6.0% | 14.81 | +5.9% |
| non_winter | 72 | 499 | 15.74 | 15.11 | 15.03 | **14.79** | +6.0% | 14.81 | +5.9% |

Blend weights (w on model, chosen per training origin on its calibration tail): +24h [0.9]; +48h [0.95]; +72h [0.95]

## High-pollution hours only (observed PM2.5 above band)

| band | h | n | persistence | seasonal-naive | **model** | skill vs persistence |
|---|---:|---:|---:|---:|---:|---:|
| observed_over_90 | 24 | 2 | 213.69 | 213.18 | **212.75** | +0.4% |
| observed_over_120 | 24 | 1 | 293.0 | 293.0 | **292.63** | +0.1% |
| observed_over_250 | 24 | 1 | 293.0 | 293.0 | **292.63** | +0.1% |
| observed_over_90 | 48 | 2 | 208.65 | 215.52 | **212.35** | -1.8% |
| observed_over_120 | 48 | 1 | 286.4 | 296.4 | **292.44** | -2.1% |
| observed_over_250 | 48 | 1 | 286.4 | 296.4 | **292.44** | -2.1% |
| observed_over_90 | 72 | 2 | 213.55 | 212.87 | **211.95** | +0.8% |
| observed_over_120 | 72 | 1 | 294.25 | 292.55 | **291.89** | +0.8% |
| observed_over_250 | 72 | 1 | 294.25 | 292.55 | **291.89** | +0.8% |
...
- **+24h**: 80% PI empirical coverage 0.806 (mean width 14.7 µg/m³); P(>90) Brier 0.0028 vs climatology 0.0028 (skill -0.1%); P(>120) Brier 0.0014 vs climatology 0.0014 (skill -0.0%); P(>250) Brier 0.0014 vs climatology 0.0014 (skill -0.2%)
- **+48h**: 80% PI empirical coverage 0.79 (mean width 16.1 µg/m³); P(>90) Brier 0.0033 vs climatology 0.0032 (skill -0.3%); P(>120) Brier 0.0016 vs climatology 0.0016 (skill -0.2%); P(>250) Brier 0.0016 vs climatology 0.0016 (skill -0.2%)
- **+72h**: 80% PI empirical coverage 0.794 (mean width 16.6 µg/m³); P(>90) Brier 0.004 vs climatology 0.004 (skill -0.4%); P(>120) Brier 0.002 vs climatology 0.002 (skill -0.2%); P(>250) Brier 0.002 vs climatology 0.002 (skill -0.2%)
