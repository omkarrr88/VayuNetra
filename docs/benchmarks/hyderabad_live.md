...
Window 2026-07-12 → 2026-08-16, test from **2026-08-07** (single temporal split; train strictly before each test origin). 6 station cells, 3,864 hourly rows. Model: LightGBM quantile (median) — same class/params as production (ml.forecast.train). Generated 2026-08-17T13:07Z by `python -m ml.eval.benchmark`.

## RMSE (µg/m³) on the shared support mask

| regime | h | n | persistence | seasonal-naive | climatology | **model** | skill vs persistence |
|---|---:|---:|---:|---:|---:|---:|---:|
| full_test | 24 | 658 | 8.18 | 10.65 | 9.12 | **7.42** | +9.2% |
| non_winter | 24 | 658 | 8.18 | 10.65 | 9.12 | **7.42** | +9.2% |
| full_test | 48 | 563 | 10.01 | 10.92 | 8.63 | **8.41** | +16.0% |
| non_winter | 48 | 563 | 10.01 | 10.92 | 8.63 | **8.41** | +16.0% |
| full_test | 72 | 456 | 11.05 | 9.65 | 8.01 | **7.23** | +34.5% |
| non_winter | 72 | 456 | 11.05 | 9.65 | 8.01 | **7.23** | +34.5% |
...
- **+24h**: 80% PI empirical coverage 0.751 (mean width 12.0 µg/m³); P(>90) Brier 0.0 vs climatology 0.0 (skill –); P(>120) Brier 0.0 vs climatology 0.0 (skill –); P(>250) Brier 0.0 vs climatology 0.0 (skill –)
- **+48h**: 80% PI empirical coverage 0.81 (mean width 14.3 µg/m³); P(>90) Brier 0.0 vs climatology 0.0 (skill –); P(>120) Brier 0.0 vs climatology 0.0 (skill –); P(>250) Brier 0.0 vs climatology 0.0 (skill –)
- **+72h**: 80% PI empirical coverage 0.75 (mean width 14.4 µg/m³); P(>90) Brier 0.0 vs climatology 0.0 (skill –); P(>120) Brier 0.0 vs climatology 0.0 (skill –); P(>250) Brier 0.0 vs climatology 0.0 (skill –)
