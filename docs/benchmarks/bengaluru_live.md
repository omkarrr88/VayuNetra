...
Window 2026-05-21 → 2026-08-17, test from **2026-07-26** (single temporal split; train strictly before each test origin). 13 station cells, 9,100 hourly rows. Model: LightGBM quantile (median) — same class/params as production (ml.forecast.train). Generated 2026-08-17T17:49Z by `python -m ml.eval.benchmark`.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| full_test | 24 | 709 | 7.84 | 7.58 | 7.72 | **6.73** | +14.2% | 6.6 | +15.9% |
| non_winter | 24 | 709 | 7.84 | 7.58 | 7.72 | **6.73** | +14.2% | 6.6 | +15.9% |
| full_test | 48 | 672 | 13.82 | 7.43 | 7.65 | **8.06** | +41.7% | 6.97 | +49.6% |
| non_winter | 48 | 672 | 13.82 | 7.43 | 7.65 | **8.06** | +41.7% | 6.97 | +49.6% |
| full_test | 72 | 703 | 13.76 | 7.56 | 7.81 | **7.35** | +46.6% | 6.63 | +51.8% |
| non_winter | 72 | 703 | 13.76 | 7.56 | 7.81 | **7.35** | +46.6% | 6.63 | +51.8% |

Blend weights (w on model, chosen per training origin on its calibration tail): +24h [0.6]; +48h [0.6]; +72h [0.7]
...
- **+24h**: 80% PI empirical coverage 0.827 (mean width 16.7 µg/m³); P(>90) Brier 0.0 vs climatology 0.0 (skill –); P(>120) Brier 0.0 vs climatology 0.0 (skill –); P(>250) Brier 0.0 vs climatology 0.0 (skill –)
- **+48h**: 80% PI empirical coverage 0.83 (mean width 17.6 µg/m³); P(>90) Brier 0.0015 vs climatology 0.0 (skill –); P(>120) Brier 0.0 vs climatology 0.0 (skill –); P(>250) Brier 0.0 vs climatology 0.0 (skill –)
- **+72h**: 80% PI empirical coverage 0.873 (mean width 20.1 µg/m³); P(>90) Brier 0.0003 vs climatology 0.0 (skill –); P(>120) Brier 0.0 vs climatology 0.0 (skill –); P(>250) Brier 0.0 vs climatology 0.0 (skill –)
