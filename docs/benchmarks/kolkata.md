...
Window 2025-02-18 → 2026-08-15, test from **2025-11-01** (rolling-origin monthly refit, 90-day training window; train strictly before each test origin). 10 station cells, 114,182 hourly rows. Model: LightGBM quantile (median) — same class/params as production (ml.forecast.train). Generated 2026-08-17T15:03Z by `python -m ml.eval.benchmark`.

## RMSE (µg/m³) on the shared support mask

| regime | h | n | persistence | seasonal-naive | climatology | **model** | skill vs persistence |
|---|---:|---:|---:|---:|---:|---:|---:|
| full_test | 24 | 53,066 | 33.75 | 39.31 | 51.75 | **29.52** | +12.5% |
| winter_nov_feb | 24 | 20,966 | 45.94 | 54.27 | 78.59 | **41.39** | +9.9% |
| non_winter | 24 | 32,100 | 22.46 | 25.13 | 19.8 | **17.94** | +20.1% |
| full_test | 48 | 53,396 | 37.33 | 39.5 | 51.83 | **34.9** | +6.5% |
| winter_nov_feb | 48 | 21,427 | 51.99 | 54.43 | 78.4 | **47.51** | +8.6% |
| non_winter | 48 | 31,969 | 22.72 | 24.91 | 19.17 | **22.83** | -0.5% |
| full_test | 72 | 53,420 | 38.64 | 40.06 | 51.91 | **38.9** | -0.7% |
| winter_nov_feb | 72 | 21,697 | 53.16 | 55.16 | 78.15 | **55.95** | -5.3% |
| non_winter | 72 | 31,723 | 24.11 | 24.93 | 19.0 | **20.18** | +16.3% |
